...
//        }
        ...
        HumanBeing humanBeing = new HumanBeing("Sam", "Porter", "Bridges", "01.01.1986");
        HumanBeing childras = new HumanBeing("BB", "Lou", "Bridges", "01.01.1986");
//        HumanBeing childdva = new HumanBeing("tugoserya", "samovich", "Bridges", "01.01.1986");

        humanBeing.setAddress(address3);

        humanBeing.setChild(childras);
//        humanBeing.setChild(childdva);
